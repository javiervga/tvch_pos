...
public class TvchApiClient {
     ...
     * @throws Exception 
     */
    public Response<UpdateContratoResponse> updateEstatusContratoReconexion(Request<UpdateContratoEstatusReconexionPosRequest> request) throws UnsupportedEncodingException, IOException, Exception {
        ...
        System.out.println("Request update estatus pago orden de servicio reconexion: " + jsonString);

        StringEntity entity = new StringEntity(jsonString);
        HttpPut httpPut = new HttpPut(url + properties.obtenerPropiedad(Constantes.TVCH_API_CONTRATO_UPDATE_RECONEXION));
        ...
        logger.info("Enviando peticion de update estatus reconexion contrato");
        ...
        if (httpResponse.getStatusLine().getStatusCode() == Constantes.CODIGO_HTTP_OK
            ...
            logger.info("Respuesta de update de estatus contrato reconexion: \n"+responseBody);
            ...
            if(httpResponse.getEntity() != null){
                String responseBody = EntityUtils.toString(httpResponse.getEntity());
                logger.warn("Fallo en respuesta de update de contrato reconexion: \n"+responseBody);
            }else{
